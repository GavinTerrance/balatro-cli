...
class BoosterPack:
    ...
    def __init__(self, name: str):
        self.name = name
        self.description = "Open to receive random cards (not implemented)"
...
class Shop:
    ...
    def generate_items(self, game):
        ...
        for i in range(2):
            self.items.append(BoosterPack(name=f"Booster Pack {i+1}"))
        ...
        if 0 <= item_index < len(self.items):
            ...
            if game.money >= item.cost:
                ...
                if isinstance(item, Joker):
                    ...
                    print("Opened booster pack (contents not implemented).")
